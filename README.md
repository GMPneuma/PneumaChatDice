...
All shipped dice artwork is stored as transparent 256×256 WebP at quality 90. The D6 artwork is normalized to identical 224×224 visible bounds with a 16-pixel canvas margin, then checked at the system's approximately 70-pixel chat size.
